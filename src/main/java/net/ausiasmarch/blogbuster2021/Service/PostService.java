...
public class PostService {
    ...
    public String getPage() throws SQLException {
        ...
        String param = oRequest.getParameter("param");
        String direction = oRequest.getParameter("direction");
        String filtro = oRequest.getParameter("filtro");
        GetPagePostBean oGetPagePostBean = null;
        try ( Connection oConnection = oConnectionPool.newConnection()) {
            PostDAO oPostDao = new PostDAO(oConnection);
            alPostBean = oPostDao.getPage(page, rpp, param, direction, filtro);
